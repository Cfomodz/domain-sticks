...
class VideoProcessor:
    ...
    def _resize_to_vertical(self, clip):
        ...
        clip = clip.resize((self.video_width, self.video_height))
    ...
    def _add_text_overlay(self, video_clip, script_data: Dict[str, Any]):
        ...
        if hook:
            ...
            hook_clip = hook_clip.set_start(0).fx(fadein, 0.5).fx(fadeout, 0.5)
        ...
        for idx, segment in enumerate(segments):
            ...
            text_clip = text_clip.set_start(start_time).fx(fadein, 0.3).fx(fadeout, 0.3)
    ...
    def _create_text_clip(
        ...
        if position == 'center':
            ...
            txt_clip = txt_clip.set_position(('center', self.video_height * 0.8))
        elif position == 'top':
            txt_clip = txt_clip.set_position(('center', self.video_height * 0.1))
